...
```
dnx generatorlog@0.0.6-alpha -- dotnet build
dnx generatorlog-analyze@0.0.6-alpha generators.nettrace
```

### As global tools

```
dotnet tool install -g GeneratorLog --version 0.0.6-alpha
dotnet tool install -g GeneratorLog.Analyze --version 0.0.6-alpha
```
