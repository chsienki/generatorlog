...
```
dnx generatorlog.analyze@0.0.7-alpha [options] <file.etl|file.nettrace|file.zip> [...]
```
...
```
dnx generatorlog@0.0.7-alpha -- dotnet build
dnx generatorlog-analyze@0.0.7-alpha generators.nettrace
```

### As global tools

```
dotnet tool install -g GeneratorLog --version 0.0.7-alpha
dotnet tool install -g GeneratorLog.Analyze --version 0.0.7-alpha
```
